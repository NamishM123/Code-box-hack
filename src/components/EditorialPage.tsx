...
export function EditorialPage({ eyebrow, title, intro, cards, action = "Map your room", href = "/capture" }: { eyebrow: string; title: string; intro: string; cards: Card[]; action?: string; href?: string }) {
